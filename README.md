...
2. From this folder:
   ...
   git branch -M main
   git remote add origin https://github.com/claudio-amorim/claudio-amorim.github.io.git
   git push -u origin main
   ```

3. On GitHub: **Settings → Pages → Build and deployment → Source: Deploy from a
   branch**, branch **`main`**, folder **`/ (root)`**. Save.
4. Wait ~1–2 minutes. Your site goes live at **https://claudio-amorim.github.io**.
